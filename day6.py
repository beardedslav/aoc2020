...
def part1(input):
    allGroupYesAnswers = 0
    for groupAnswers in input.split('\n\n'):
        yesAnswers = set()
        for personAnswers in groupAnswers.split('\n'):
            yesAnswers = yesAnswers.union(personAnswers)
        allGroupYesAnswers += len(yesAnswers)
    return allGroupYesAnswers

def part2(input):
    allGroupYesAnswers = 0
    for groupAnswers in input.split('\n\n'):
        allGroupAnswers = groupAnswers.split('\n')
        yesAnswers = set(allGroupAnswers[0])
        for personAnswers in allGroupAnswers[1:]:
            yesAnswers = yesAnswers.intersection(personAnswers)
        allGroupYesAnswers += len(yesAnswers)
    return allGroupYesAnswers 
